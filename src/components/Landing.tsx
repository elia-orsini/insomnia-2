    ...
    <div className="h-dvh overflow-clip">
      ...
      <div className="absolute bottom-0 left-0 z-30 flex flex-row gap-x-8 p-5">
        <a
          ...
          target="_blank"
          href="https://www.facebook.com/InsomniaPageOfficial"
        >
          <svg
        ...
        <a
          className="hover:cursor-cell"
          target="_blank"
          href="https://www.instagram.com/insomnia.01"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <a
          className="hover:cursor-cell"
          href="https://open.spotify.com/user/e1ex6sgsk9ocg117lon5jfx9n?si=QEVdTBm9QECsK6X7ORDcRQ"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <div className="absolute z-10">
          ...
          >
            <div className="fixed right-0 mb-20 w-screen p-4 text-left md:w-[50vw] md:p-10">
              <a
                href="https://www.facebook.com/InsomniaPageOfficial/photos_albums"
                target="_blank"
                className="block text-left text-xl uppercase underline hover:cursor-cell"
              >
                photos
              </a>
              ...
              {menuItems.map((item: any) => (
                <button
                  key={item.id}
                  className="mt-7 block text-left text-xl uppercase underline hover:cursor-cell"
              ...
              <p className="mt-14 hidden text-left font-mono text-[0.7rem] text-white sm:mt-24 sm:block sm:text-[0.9rem]">
                return &#123; <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/lucafontana.mp3"
                >
                  lucafontana
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/alessio.dali"
                >
                  dali
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/rinobellandi"
                >
                  xy71
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/filo.wav"
                >
                  filo.wav
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/_vincenzofraccica_"
                >
                  vinci
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/elig.ace"
                >
                  elig.ace
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/elig.graphics"
                >
                  elig.graphics
                </a>
                <br />
                ...
                <a
                  target="_blank"
                  className="hover:cursor-cell hover:underline"
                  href="https://instagram.com/kristoffer.castroo"
                >
                  kristoffer.castro
                </a>
                <br />
          ...
          {!!activeSection && (
            <div className="section-content">
              <div className="fixed right-0 z-0 h-screen w-screen p-4 md:w-[50vw] md:p-10">
                ...
                <p className="text-base sm:text-lg">{sectionContent[activeSection].text}</p>
